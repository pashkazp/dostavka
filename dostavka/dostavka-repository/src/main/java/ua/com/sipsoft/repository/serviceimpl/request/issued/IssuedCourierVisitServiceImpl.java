package ua.com.sipsoft.repository.serviceimpl.request.issued;
...
import ua.com.sipsoft.repository.request.issued.CourierVisitRepository;
import ua.com.sipsoft.service.request.draft.CourierRequestService;
import ua.com.sipsoft.service.request.issued.IssuedCourierVisitService;
...
import ua.com.sipsoft.service.util.history.CourierVisitSnapshot;
...
public class IssuedCourierVisitServiceImpl implements IssuedCourierVisitService, HasQueryToSortConvertor {
	...
	/** The dao. */
	private final CourierVisitRepository dao;
	...
	public Optional<CourierVisit> registerChangesAndSave(CourierVisit visit, CourierVisitSnapshot visitSnapshot,
		...
		visitSnapshot.fillHistoryChangesTo(visit, UsersUtils.getCurrentUser());
