...
public class AppNotifyMsg {
	...
	public static final String USER_NOT_ADDED = "app.note.user.not.added";
	public static final String FACILITY_NOT_SAVED = "app.note.facility.not.saved";
	public static final String FACILITY_NOT_ADDED = "app.note.facility.not.added";
	...
	public static final String FACILITYADDR_NOT_ADDED = "app.note.facility.addr.not.added";
