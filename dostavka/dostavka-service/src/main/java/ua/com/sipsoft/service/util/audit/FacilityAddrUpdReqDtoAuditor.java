...
public class FacilityAddrUpdReqDtoAuditor implements UpdateRequestPropertyAuditor<FacilityAddrUpdReqDto> {
	...
	@Override
	public AuditResponse inspectUpdatedData(FacilityAddrUpdReqDto inspectedInfo, AuditResponse result,
			Locale loc) {
		if (result == null) {
