...
import ua.com.sipsoft.dao.request.prototype.AbstractHistoryEvent;
...
public class ArchivedCourierVisitEvent extends AbstractHistoryEvent implements Serializable {
	...
	public ArchivedCourierVisitEvent(String description, User author, LocalDateTime creationDateTime) {
		...
		log.info("Instantiates history messsage event. Author #'{}' '{}' date {} description '{}'", author.getId(),
				author.getName(), creationDateTime, description);
	}
}