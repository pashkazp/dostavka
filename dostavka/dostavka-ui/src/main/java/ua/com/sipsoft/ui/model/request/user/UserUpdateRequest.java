...
public class UserUpdateRequest implements Serializable {
	...
	public String toString() {
		...
		builder.append("UserUpdateRequest [id=").append(id).append(", email=").append(email).append(", password=")
				.append("*".repeat(getPasswordLength())).append(", confirmPassword=")
				.append("*".repeat(getCPasswordLength())).append(", name=").append(name)
